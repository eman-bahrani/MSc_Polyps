...
# Combine plots using patchwork, stacking them vertically
combined_plot <- ma_ggplot / pca_plot / volcano_plot +
  plot_layout(ncol = 1, heights = c(1, 1, 1.2))  # Adjust heights as needed

# Save the combined plot
ggsave(filename = "../Output/combined_plot_cluster_1.png", plot = combined_plot, width = 12, height = 20, dpi = 300)
...
ma_ggplot2 <- ggplot(as.data.frame(results_cluster_2), aes(x = baseMean, y = log2FoldChange)) +
  geom_point(alpha = 0.5) +
  labs(title = "MA Plot - Cluster 2", x = "Base Mean", y = "Log2 Fold Change") +
  scale_x_log10() +
  common_theme
...
# Combine plots using patchwork, stacking them vertically
combined_plot <- ma_ggplot2 / pca_plot2 / volcano_plot2 +
  plot_layout(ncol = 1, heights = c(1, 1, 1.2))  # Adjust heights as needed

# Save the combined plot
ggsave(filename = "../Output/combined_plot_cluster_2.png", plot = combined_plot, width = 12, height = 20, dpi = 300)
```
...
ma_ggplot3 <- ggplot(as.data.frame(results_cluster_3), aes(x = baseMean, y = log2FoldChange)) +
  geom_point(alpha = 0.5) +
  labs(title = "MA Plot - Cluster 3", x = "Base Mean", y = "Log2 Fold Change") +
  scale_x_log10() +
  common_theme
...
# Combine plots using patchwork, stacking them vertically
combined_plot3 <- ma_ggplot3 / pca_plot3 / volcano_plot3 +
  plot_layout(ncol = 1, heights = c(1, 1, 1.2))  # Adjust heights as needed

# Save the combined plot
ggsave(filename = "../Output/replotting_combined_plot_cluster_3.png", plot = combined_plot3, width = 12, height = 20, dpi = 300)
```
...
ma_ggplot4 <- ggplot(as.data.frame(results_cluster_4), aes(x = baseMean, y = log2FoldChange)) +
  geom_point(alpha = 0.5) +
  labs(title = "MA Plot - Cluster 4", x = "Base Mean", y = "Log2 Fold Change") +
  scale_x_log10() +
  common_theme
...
# Combine plots using patchwork, stacking them vertically
combined_plot4 <- ma_ggplot4 / pca_plot4 / volcano_plot4 +
  plot_layout(ncol = 1, heights = c(1, 1, 1.2))  # Adjust heights as needed

# Save the combined plot
ggsave(filename = "../Output/replotting_combined_plot_cluster_4.png", plot = combined_plot4, width = 12, height = 20, dpi = 300)
```
